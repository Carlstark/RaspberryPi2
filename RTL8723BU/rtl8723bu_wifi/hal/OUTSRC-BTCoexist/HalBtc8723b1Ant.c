	...
	)
{
	...
	do
	{
		...
		case 0:
			...
			else
			{
				...
				if (i == 14)
				{
					...
					BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Abort!!, Invalid LE channel = %d\n ",  BTLEChannel));
					outloop = TRUE;
					break;
				}
			}
			...
			BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), BT_LETxTime=%d,  BT_LECh = %d\n", BTTxTime, BTLEChannel));
			BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), WLPSD_CentFreq=%d,  WLPSD_Offset = %d, WLPSD_Span = %d, WLPSD_SweepCount = %d\n",
		...
		case 1: //stop coex DM & set antenna path
			...
			BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Stop Coex DM!!\n"));
			...
			if(pBoardInfo->btdmAntPos == BTC_ANTENNA_AT_MAIN_PORT)
			{
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Antenna at Main Port\n"));
			}
			else
			{
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Antenna at Aux Port\n"));
			}

			//Set Antenna path, switch WiFi to un-certain antenna port
			halbtc8723b1ant_SetAntPath(pBtCoexist, BTC_ANT_PATH_BT, FORCE_EXEC, FALSE, FALSE);

			BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Set Antenna to BT!!\n"));
			...
			BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Set AFH on, Cent-Ch= %d,  Mask=%d\n",
			...
			u1Tmpb = pBtCoexist->fBtcRead1Byte(pBtCoexist, 0x778);
			 ...
			 BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("############# [BTCoex], 0x948=0x%x, 0x765=0x%x, 0x778=0x%x\n",
					u4Tmp,  u1Tmpa, u1Tmpb));
		...
		case 2:	//Pre-sweep background psd
			...
			{
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), PSDGenCount = %d\n ",  pPsdScan->nPSDGenCount));
			...
			{
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Abort Antenna Detection!! becaus background = %d > thres (%d)\n",
			...
			{
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Start Antenna Detection!! becaus background = %d <= thres (%d)\n",
					pPsdScan->nPSDMaxValue/100, BT_8723B_1ANT_ANTDET_PSDTHRES_BACKGROUND+pPsdScan->nAntDet_ThresOffset));
				state = 3;
			}
			break;
		...
		case 4:
			...
			if (freq2 < 100)
			{
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Max Value: Freq = %d.0%d MHz", freq1, freq2));
				CL_SPRINTF(pPsdScan->nAntDet_PeakFreq, BT_8723B_1ANT_ANTDET_BUF_LEN, "%d.0%d", freq1,freq2);
			}
			else
			{
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Max Value: Freq = %d.%d MHz",  freq1, freq2));
				CL_SPRINTF(pPsdScan->nAntDet_PeakFreq, BT_8723B_1ANT_ANTDET_BUF_LEN, "%d.%d", freq1,freq2);
			}

			if (PsdRep2 < 10)
			{
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, (", Value = %d.0%d dB\n",   PsdRep1, PsdRep2));
				CL_SPRINTF(pPsdScan->nAntDet_PeakVal, BT_8723B_1ANT_ANTDET_BUF_LEN, "%d.0%d", PsdRep1,PsdRep2);
			}
			else
			{
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, (", Value = %d.%d dB\n",PsdRep1, PsdRep2));
			...
			if (BTResp == FALSE)
			{
				...
				pBoardInfo->btdmAntDetFinish = FALSE;
				pBoardInfo->btdmAntNumByAntDet = 1;
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), BT Response = Fail \n "));
			}
			else if (pPsdScan->nPSDMaxValue > (BT_8723B_1ANT_ANTDET_PSDTHRES_2ANT_BADISOLATION)*100)
			{
				...
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Detect Result = 2-Ant, Bad-Isolation!! \n"));
			}
			else if (pPsdScan->nPSDMaxValue > (BT_8723B_1ANT_ANTDET_PSDTHRES_2ANT_GOODISOLATION+pPsdScan->nAntDet_ThresOffset)*100)
			{
				...
				pBoardInfo->btdmAntDetFinish = TRUE;
				pBoardInfo->btdmAntNumByAntDet = 2;
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Detect Result = 2-Ant, Good-Isolation!! \n"));
			}
			else if (pPsdScan->nPSDMaxValue > (BT_8723B_1ANT_ANTDET_PSDTHRES_1ANT)*100)
			{
				...
				pBoardInfo->btdmAntDetFinish = TRUE;
				pBoardInfo->btdmAntNumByAntDet = 1;
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Detect Result = 1-Ant!!\n"));
			}
			else
			{
				...
				pBoardInfo->btdmAntDetFinish = FALSE;
				pBoardInfo->btdmAntNumByAntDet = 1;
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Detect Result = 1-Ant, un-certainity!!\n"));
			}
		...
		case 99:  //restore setup
			...
			//Set Antenna Path
			halbtc8723b1ant_SetAntPath(pBtCoexist, BTC_ANT_PATH_PTA, FORCE_EXEC, FALSE, FALSE);
			BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Set Antenna to PTA\n!!"));

			//Resume Coex DM
			pBtCoexist->bStopCoexDm = FALSE;
			BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Resume Coex DM\n!!"));

			//stimulate coex running
			halbtc8723b1ant_RunCoexistMechanism(pBtCoexist);
			BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Stimulate Coex running\n!!"));
	...
	)
{
	...
	BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx Execute 8723b 1-Ant PowerOn Setting xxxxxxxxxxxxxxxx!!\n"));

	BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("Ant Det Finish = %s, Ant Det Number  = %d\n",
	...
	)
{
	...
	if (!pBoardInfo->btdmAntDetFinish)
	{
		...
		{
			BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Antenna Det Timer is up, Try Detect!!\n"));
			halbtc8723b1ant_PSD_AntennaDetectionCheck(pBtCoexist);	
			
			if (pBoardInfo->btdmAntDetFinish)
			{
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Antenna Det Success!!\n"));
#if 1
				if (pBoardInfo->btdmAntNumByAntDet == 2)
				...
				BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Antenna Det Fail!!\n"));

			pPsdScan->nAntDet_IntevalCount = 0;
		}
		else
		{
			BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE, ("xxxxxxxxxxxxxxxx AntennaDetect(), Antenna Det Timer is not up! (%d)\n", pPsdScan->nAntDet_IntevalCount));
		}
